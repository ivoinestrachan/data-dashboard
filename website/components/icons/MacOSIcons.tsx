...
// Animation variants pour tous les icônes
const iconVariants = {
  initial: { scale: 1 },
  hover: {
    scale: 1.1,
...
export function PlayIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      />
      <defs>
        <linearGradient id="playGradient" x1="3" y1="3" x2="21" y2="21">
...
// Icône Shopping Bag - Style macOS
...
// Icône Grid/Gallery - Style macOS
export function GridIcon({ className = "", size = 24 }: IconProps) {
  return (
    <motion.svg
      ...
      className={className}
    >
      <motion.rect x="3" y="3" width="7" height="7" rx="2" stroke="currentColor" strokeWidth="1.5" />
      <motion.rect x="14" y="3" width="7" height="7" rx="2" stroke="currentColor" strokeWidth="1.5" />
      <motion.rect x="3" y="14" width="7" height="7" rx="2" stroke="currentColor" strokeWidth="1.5" />
      <motion.rect x="14" y="14" width="7" height="7" rx="2" stroke="currentColor" strokeWidth="1.5" />
    </motion.svg>
  )
}

// Icône Robot - Style macOS
  ...
  return (
    ...
    >
      <motion.rect
        ...
        strokeWidth="1.5"
      />
      <motion.circle cx="9" cy="13" r="1.5" fill="currentColor" />
      <motion.circle cx="15" cy="13" r="1.5" fill="currentColor" />
      <motion.path
        d="M9 17H15"
        stroke="currentColor"
        strokeWidth="1.5"
